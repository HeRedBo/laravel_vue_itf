  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-info">
        ...
        <el-form ref="studentForm"  :model="studentForm" :rules="studentRules"  label-width="90px" class="el-form"
        ...
        <div class="box-body">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">学生基本信息</a></li>
              <li><a href="#tab_2" data-toggle="tab">学生卡券信息</a></li>
              ...
              <div class="tab-pane active" id="tab_1">
                  <div class="col-md-9">
                        ...
                        <el-form-item label="学生姓名" prop="name">
                          <el-input v-model="studentForm.name" placeholder="请输入姓名" :class="mystyle"></el-input>
                        </el-form-item>
                     ...
                     <el-table
                          ...
                          style="min-width: 650px;margin-bottom: 20px;max-width: 700px"
                          align="cneter"
                        >
              ...
              <div class="tab-pane" id="tab_2">
                  ...
                  <!-- 卡券种类 -->
                        ...
                        <el-table
                          ...
                          style="min-width: 650px;margin-bottom: 20px;max-width: 800px"
                          align="cneter"
                        >
                            <el-table-column
                                prop="card_id"
...
<style type="text/css">
  ...
  .el-input.mystyle ,.el-textarea.mystyle {
    width: 450px;
  }

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    <el-form ref="userForm" :model="userForm" :rules="userRules" label-width="80px" class="el-form" style="width: 41%;
                      margin-left: 10%;
                      margin-top: 20px;">
                        ...
                        <el-form-item label="头像">
                            <div class="components-container">
                                ...
                                <image-cropper :width="300" :height="300" url="/upload/upAvatar" @close='close' @crop-upload-fail='cropUploadFail' @crop-upload-success="cropSuccess"
                        ...
                        <el-form-item>
                            ...
                            <el-button type="submit" @click="$router.back();">
                                 返回
                            </el-button>

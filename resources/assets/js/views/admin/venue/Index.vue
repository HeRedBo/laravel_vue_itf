      ...
      <div class="box">
        <div class="box-header">
           <div class="row">
              <div class="col-md-2">
                <span>
                    <router-link :to="{path:'create'}" v-if="can('admin.venue.create')" class="btn btn-sm btn-success">
                      添加
                    </router-link>
                </span>  
              </div>  
         ...
         <vTable ref="table"
              ...
              <template slot="LOGO" slot-scope="item">
                     ...
                     <div style="text-align: right; margin: 0">
                        <img :src="item.item.logo" width="400px" height="400px" class="user-avatar "/>
                     </div>
                    </el-popover>
                      <img :src="item.item.logo_thumb" width="40px" height="40px" class="user-avatar img-circle" v-popover:popover />
                </template>
